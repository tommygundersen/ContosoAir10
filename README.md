[![Build Status](https://dev.azure.com/devops-emsi/ContosoAir/_apis/build/status/achrafbilal.ContosoAir?branchName=master)](https://dev.azure.com/devops-emsi/ContosoAir/_build/latest?definitionId=8&branchName=master)
